          ...
          {filteredUsers(formik.values.user).map(user => {
            return (
              <tr key={user.uid}>
                ...
                <td>{user.email}</td>
                <td>{user.isAdmin && <i className='fas fa-check' />}</td>
                <td>{user.refRosterRaidLeader && <i className='fas fa-check' />}</td>
                <td>{user.isCrafter && <i className='fas fa-check' />}</td>
                <td>{user.isGatherer && <i className='fas fa-check' />}</td>
