                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div className='d-flex flex-row'>
                          <CopyToClipboard text={log.fflogurl}>
                            <Button><i className='fas fa-clipboard' /></Button>
                          </CopyToClipboard>
                          {(isRaidLeadOrAdmin || user.uid === log.uid) && <Button variant='danger' style={{ marginLeft: '2px' }} onClick={() => handleDeleteLog(log)}><i className='fas fa-trash' /></Button>}
                        </div>
